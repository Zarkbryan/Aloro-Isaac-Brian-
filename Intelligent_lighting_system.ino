      ...
      if (client.available()) {
        ...
        if (c == '\n') {
          if (currentLine.length() == 0) {
            ...
            client.println("<!DOCTYPE html><html><head><title>Aloro Systems Lighting</title>");
            ...
            client.println("<h1>Aloro Systems</h1>");
            ...
            client.println("</div>");
            client.println("<footer>&copy; 2025 Aloro Isaac Brian| Team Innovators</footer>");
